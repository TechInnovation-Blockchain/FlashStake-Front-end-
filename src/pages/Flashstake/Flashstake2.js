    ...
    <PageAnimation in={true} reverse={animation > 0}>
      <Fragment>
        ...
        <Dialog
          ...
          //    </Typography>
          //    <Button2 variant="red" fullWidth onClick={onClickClose}>
          //      CLOSE
          //    </Button2>
          //  </Fragment>
          //),
          ...
          {
            {
              ...
              earlyUnstakeFull: (
                <Fragment>
                  ...
                  <Button2 variant="red" fullWidth onClick={unstakeEarly}>
                    UNSTAKE
                  </Button2>
                </Fragment>
              ),
                ...
                parseFloat(dappBalance) > parseFloat(expiredDappBalance) ? (
                  parseFloat(expiredDappBalance) === 0 ? (
                    ...
                    <Fragment>
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={6}>
                          <Button2 variant="red" fullWidth onClick={unstakeXIO}>
