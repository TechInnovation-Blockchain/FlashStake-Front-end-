...
function Pool({
  ...
  const showConversionAlert = () => {
    if (new BigNumber(quantityAlt).gt(new BigNumber(wethBalance))) {
      // setTimeout(() => {
      setShowAlert(true);
      // }, 700);
          ...
          <Accordion square expanded={expanded2}>
            ...
            >
              <Grid container spacing={2}>
                ...
                <Grid
                  item
                  className={`${classes.gridSpace2} ${classes.selectGrid}`}
                  xs={6}
                >
                  <Typography
                    // variant="body2"
                  ...
                  {selectedRewardToken?.tokenB?.address?.toLowerCase() ===
                    ...
                    >
                      <Box
                        ...
                        onMouseOver={() => setOpenAlert(true)}
                        onMouseOut={() => setOpenAlert(false)}
                      >
          ...
          {
            {
              ...
              successLiquidity: (
                <Fragment>
                  ...
                  >
                    <a
                      href={`https://etherscan.io/tx/${liquidityTxnHash}`}
                      target="_blank"
              ...
              successWithdrawLiquidity: (
                <Fragment>
                  ...
                  >
                    <a
                      href={`https://etherscan.io/tx/${withdrawLiquidityTxnHash}`}
