...
// export const calculateBurn = (portal) => async (dispatch, getState) => {
//   try {
//     let burn = 0;
...
//       contract: { baseInterestRate },
//     } = getState();
//     const _baseInterestRate = Web3.utils.fromWi

//     if (portal && portal.stakes) {
//       portal.stakes
//         .filter((_stake) => !_stake.expired)
//         .map((_stake) => {
//           const totalDuration = parseFloat(_stake.endTimestamp) / 60;
//           const remainingDuration =
//             (parseFloat(_stake.initialTimestamp) +
//               parseFloat(_stake.endTimestamp) -
//               Math.ceil(Date.now() / 1000)) /
...
//         });
//     }
//     return burn.toFixed(18);
//   } catch (e) {
//     console.error("ERROR calculateBurn -> ", e);
//   }
// };
